	...
	var factory = {
	    ...
	    getAllMasterDataRoutes: function(baseRouter)
	    {
	        var routes = {
				...
				'Autos': _.partial(BaseRouter.showView, baseRouter, 'l!t!Settings/Autos', { Materials: true, Instruments: true, }, false),
	            'Autos/create': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddAutos', 'models/Settings/Autos', { Materials: true, Instruments: true, }, false),
	            'Autos/:id': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddAutos', 'models/Settings/Autos', { Materials: true, Instruments: true, }, false),
