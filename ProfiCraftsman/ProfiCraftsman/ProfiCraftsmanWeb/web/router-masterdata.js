	...
	var factory = {
	    ...
	    getAllMasterDataRoutes: function(baseRouter)
	    {
	        var routes = {
				...
				'EmployeeRateRsps': _.partial(BaseRouter.showView, baseRouter, 'l!t!Settings/EmployeeRateRsps', { JobPositions: true, }, false),
	            'EmployeeRateRsps/create': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddEmployeeRateRsp', 'models/Settings/EmployeeRateRsp', { JobPositions: true, }, false),
	            'EmployeeRateRsps/:id': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddEmployeeRateRsp', 'models/Settings/EmployeeRateRsp', { JobPositions: true, }, false),
				'CustomProducts': _.partial(BaseRouter.showView, baseRouter, 'l!t!Settings/CustomProducts', false, false),
	            'CustomProducts/create': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddCustomProducts', 'models/Settings/CustomProducts', false, false),
	            'CustomProducts/:id': _.partial(BaseRouter.showViewWithModel, baseRouter, 'l!t!Settings/AddCustomProducts', 'models/Settings/CustomProducts', false, false),
