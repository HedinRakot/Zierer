	...
	var router = Backbone.Router.extend({
		...
		routes: function() {
		    ...
		    var commonRoutes =
            {
                ...
                'Offers': _.partial(BaseRouter.showView, this, 'l!t!Orders/Offers', { ProductTypes: true, Equipments: true, PaymentTypes: true }, { isOffer: true }),
                'Offers/create': _.partial(BaseRouter.showViewWithModel, this, 'l!t!Orders/AddOrders', 'models/Orders', { ProductTypes: true, CommunicationPartners: true, Equipments: true }, { isOffer: true }),
                'Offers/:id': _.partial(BaseRouter.showViewWithModel, this, 'l!t!Orders/AddOrders', 'models/Orders', { ProductTypes: true, CommunicationPartners: true, Equipments: true }, { isOffer: true }),
                'Orders': _.partial(BaseRouter.showView, this, 'l!t!Orders/Orders', { ProductTypes: true, Equipments: true, PaymentTypes: true }, { isOffer: false }),
                'Orders/create': _.partial(BaseRouter.showViewWithModel, this, 'l!t!Orders/AddOrders', 'models/Orders', { ProductTypes: true, CommunicationPartners: true, Equipments: true, PaymentTypes: true }, { isOffer: false }),
                'Orders/:id': _.partial(BaseRouter.showViewWithModel, this, 'l!t!Orders/AddOrders', 'models/Orders', { ProductTypes: true, CommunicationPartners: true, Equipments: true, PaymentTypes: true }, { isOffer: false }),
